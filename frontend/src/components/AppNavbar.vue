  ...
  <header class="app-navbar">
    <div class="app-navbar__inner">
      <div class="app-navbar__brand">
        <RouterLink to="/documents" class="brand-link">
          <span class="brand-title">EBSA Alturas</span>
          <span class="brand-subtitle">Gestión documental y control de acceso</span>
        </RouterLink>
      </div>
        ...
        <template v-if="auth.isAuthenticated">
          <div class="session-box">
            <div class="session-line">
              ...
              <span
                class="role-pill"
                :class="auth.isSuperAdmin ? 'role-admin' : 'role-operator'"
              >
                {{ auth.isSuperAdmin ? 'SUPER_ADMIN' : 'OPERADOR' }}
              </span>
            </div>

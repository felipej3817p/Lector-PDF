...
export const useAuthStore = defineStore('auth', {
  ...
  getters: {
    ...
    isSuperAdmin: (state) => Array.isArray(state.user?.roles) && state.user.roles.includes('SUPER_ADMIN'),
    allowedAreas: (state) => Array.isArray(state.user?.allowedAreas) ? state.user.allowedAreas : []
  },

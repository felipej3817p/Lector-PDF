export const AREA_OPTIONS = [
  ...
  { value: 'DIRECCION_TELEMATICA', label: 'DIRECCION DE TELEMATICA' },
  { value: 'DIRECCION_AUTOMATIZACION', label: 'DIRECCION DE AUTOMATIZACION' }
]
...
const PRIMARY_AREA_CODES = [
  ...
  'DIRECCION_OPERACION',
  'DIRECCION_PERDIDAS',
  'DIRECCION_TELEMATICA',
  'DIRECCION_AUTOMATIZACION'
]
...
const AREA_ALIASES = {
  ...
  DIRECCION_TELEMATICA: 'DIRECCION_TELEMATICA',
  DIRECCION_DE_TELEMATICA: 'DIRECCION_TELEMATICA',
  DIRECCION_AUTOMATIZACION: 'DIRECCION_AUTOMATIZACION',
  DIRECCION_DE_AUTOMATIZACION: 'DIRECCION_AUTOMATIZACION',
